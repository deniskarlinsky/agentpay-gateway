 ...
 * autoconfig opens its connection eagerly). Scenarios A and G do not exercise ComplianceAgent —
 * the Iter 3 stub Supervisor returns APPROVED unconditionally — so the MCP client has no business
